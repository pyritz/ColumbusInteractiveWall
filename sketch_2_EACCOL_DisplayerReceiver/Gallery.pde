/*  File    : Gallery Object on Corridor Display-Receiver
 *  Version : 1.0.0
 *  Update  : 28/04/2014
...
public class Gallery
{
  ...
  Gallery(int x, int y, ObjectOrientation orientation, String title, String text)
  {
    this.x = x;
    this.y = y;
    ...
    this.images[0] = loadImage("gallery/LucaCOL1.jpg");
    this.images[1] = loadImage("gallery/LucaCOL2.jpg");
    this.images[2] = loadImage("gallery/LucaCOL3.jpg");
  ...
  { 
    ...
    if (this.stage >= 4)
    {      
      image(this.images[this.currentImage], this.x + this.lineMargin, this.y - 155, 250, 166);
      image(this.arrow, this.x + this.lineMargin + 250 + 10, this.y - 13);
    }
